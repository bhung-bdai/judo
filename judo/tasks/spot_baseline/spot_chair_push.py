...
from judo.tasks.spot_baseline.spot_constants import LEGS_STANDING_POS, STANDING_HEIGHT
...
class SpotChairPushBaseline(SpotLocomotion):
    ...
    def success(
        self, model: MjModel, data: MjData, config: SpotChairPushBaselineConfig, metadata: dict[str, Any] | None = None
    ) -> bool:
