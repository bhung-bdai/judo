...
class SpotBarrierUpright(SpotBase[SpotBarrierUprightConfig]):
    ...
    def reward(
        ...
        gripper_joint_pos = qpos[
            ..., 1:, self.gripper_joint_idx
        ]  # Actual position (0.0=closed, -1.54=open), skip initial state
    ...
    def success(
        self, model: MjModel, data: MjData, config: SpotBarrierUprightConfig, metadata: dict[str, Any] | None = None
    ) -> bool:
