...
"""SpotYellowChairPush task - push a yellow chair to a goal.

Adapted from starfish/dexterity/tasks/spot_yellow_chair_push.py.
"""
...
XML_PATH = str(MODEL_PATH / "xml" / "spot_yellow_chair" / "robot.xml")
...
@dataclass
class SpotYellowChairPushConfig(SpotBaseConfig):
    """Configuration for the SpotYellowChairPush task."""
...
class SpotYellowChairPush(SpotBase[SpotYellowChairPushConfig]):
    """Task getting Spot to push a yellow chair to a desired goal location."""

    name: str = "spot_yellow_chair_push"
    config_t: type[SpotYellowChairPushConfig] = SpotYellowChairPushConfig  # type: ignore[assignment]
    config: SpotYellowChairPushConfig

    def __init__(
        self,
        config: SpotYellowChairPushConfig | None = None,
    ) -> None:
        """Initialize the SpotYellowChairPush task."""
    ...
    def reward(
        ...
        """Reward function for the yellow chair push task."""
        ...
        orientation_alignment = np.minimum(
        ...
        return (
            spot_fence_reward + spot_fallen_reward + goal_reward + object_orientation_reward
    ...
    def reset_pose(self) -> np.ndarray:
        """Reset pose for the yellow chair push task."""
