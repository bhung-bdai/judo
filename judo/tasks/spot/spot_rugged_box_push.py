...
class SpotRuggedBoxPush(SpotBase[SpotRuggedBoxPushConfig]):
    ...
    def reward(
        ...
        box_orientation_reward = -config.w_orientation * (x_alignment + y_alignment + z_alignment).mean(axis=-1)
    ...
    def success(
        self, model: MjModel, data: MjData, config: SpotRuggedBoxPushConfig, metadata: dict[str, Any] | None = None
    ) -> bool:
