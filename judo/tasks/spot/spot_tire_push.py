...
class SpotTirePush(SpotBase):
    ...
    def __init__(self, model_path: str = XML_PATH) -> None:
        ...
        self.tire_y_axis_idx = get_sensor_indices(self.model, "object_y_axis")
    ...
    def success(
        self, model: MjModel, data: MjData, config: SpotTirePushConfig, metadata: dict[str, Any] | None = None
    ) -> bool:
